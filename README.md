...
-> En soit les derniers point sont réalisés, mais le player perd ses vies rapidement et donc meurt résultat le système de vie ne sert pas à grand chose


**BONUS**
- [X] : Create random number of ennemie at random position
